...
global.syt = 'https://youtube.com/@dickyy_heriyanto'
/*============== NOMOR ==============*/
global.owner = ['6285175463174'] //isi nomer owner nya 
global.nomerown = '6285175463174'
global.premium = ['6285175463174']
global.nomorbot = ""
global.develover = "6285175463174@s.whatsapp.net";
/*============== OWNER X NAMABOT ==============*/
global.namaowner = "SunShine"
global.namebot = "SunShine"
...
global.pgopay = '-'
global.plinkaja = '-'
global.ppulsa = '0851-7546-3174' 
global.ppulsa2 = '0851-7546-3174'
/*============== STICKER ==============*/
global.packname = ""
global.author = "Sticker By SunShine"
/*============== HIASAN =============*/
global.htki = '––––––『' // Hiasan Titile (KIRI)
global.htka = '』––––––' // Hiasan Title  (KANAN)
global.htjava = pickRandom(["⛶", "❏", "⫹⫺", "☰", "⎔", "✦", "⭔", "⬟", "⛊", "⚝"])    //hiasan Doang :v
/*============== WATERMARK ==============*/
global.v = 'YT: SunShine '
global.wm = '© SunShine'
global.footer = 'ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ sᴜɴsʜɪɴᴇ ッ'
/*============== IMAGE X LINK ==============*/
global.zykomd = 'https://telegra.ph//file/1a330ca1ca4e1dcce4df7.jpg'
global.menu = 'https://telegra.ph//file/1a330ca1ca4e1dcce4df7.jpg'
global.fla = 'https://telegra.ph//file/1a330ca1ca4e1dcce4df7.jpg'
global.brocas = "https://telegra.ph//file/1a330ca1ca4e1dcce4df7.jpg"
...
/*============== CREATE PANEL ==============*/
global.domain = 'https://oktzoffc.pannelvvip.my.id' // ISI LINK DOMAIN
global.apikey = 'ptla_e1kfX8wdZMsen7lKlWq9Qr9NYoXAu9nr3RcETVSUF4y' // ISI APIKEY PTLA
global.c_apikey = 'ptlc_XYxjF2wnTjcpqXmVnjQlfNlN2cQCvA3eGlUvY5eFFzw' // ISI APIKEY PTLC
/*============== MESS ==============*/
global.mess = {
    success: 'Success ✓',
    done: 'Success ✓',
